-- ============================================================================
-- HOTFIX: create_channel_message tham chieu sai ten bang
--
-- Migration 20260825120000_message_external_media.sql goi public.server_member_roles,
-- nhung bang gan vai tro cua project ten la public.member_roles (tao tu
-- 20260731090200_servers_roles_channels.sql). Hau qua: MOI tin nhan gui vao
-- kenh deu that bai voi loi 42P01 (relation does not exist).
--
-- Cot dung y het nhau (role_id, server_id, user_id) nen chi doi ten bang.
-- Chay file nay trong Supabase SQL Editor de cap nhat function.
-- ============================================================================
