-- ============================================================================
-- HOTFIX #2: create_channel_message dung sai ten cot channel_overwrites
--
-- Ban truoc (20260826_fix_create_channel_message_member_roles.sql) da sua
-- server_member_roles -> member_roles, nhung van con sai o cho khac trong
-- CUNG migration 20260825120000_message_external_media.sql: doc cot
-- allow_permissions/deny_permissions tren public.channel_overwrites, trong
-- khi ten cot that (dinh nghia o 20260731090200_servers_roles_channels.sql,
-- va da dung dung o server-permissions.service.ts:249) la allow/deny.
--
-- Hau qua: sau khi vua sua loi 42P01, tin nhan vao kenh lai gay loi khac
-- 42703 "column allow_permissions does not exist" ngay khi user KHONG PHAI
-- chu server gui tin (nhanh nay moi cham toi channel_overwrites).
--
-- Chay file nay trong Supabase SQL Editor de cap nhat function (thay the
-- hoan toan cho lan chay hotfix truoc do).
-- ============================================================================
